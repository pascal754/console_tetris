...
void TetrominoL::moveLeft(const Grid& g)
{
...
void TetrominoL::moveRight(const Grid& g)
{
...
bool TetrominoL::moveDown(const Grid& g)
{
	TetrominoL temp{ *this };
	++temp.y;
...
void TetrominoL::drop(const Grid& g)
{
	TetrominoL temp{ *this };
