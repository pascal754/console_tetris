...
void TetrominoS::moveLeft(const Grid& g)
{
...
void TetrominoS::moveRight(const Grid& g)
{
...
bool TetrominoS::moveDown(const Grid& g)
{
	TetrominoS temp{ *this };
	++temp.y;
...
void TetrominoS::drop(const Grid& g)
{
	TetrominoS temp{ *this };
